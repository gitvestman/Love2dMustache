function level3()   
    ...
    objects.landscape = {}
    objects.landscape.body = love.physics.newBody(world, 100, 650-250/2 + level)
    objects.landscape.shape = love.physics.newRectangleShape(200, 150 - level)
    objects.landscape.fixture = love.physics.newFixture(objects.landscape.body, objects.landscape.shape)

    objects.landscape2 = {}
    objects.landscape2.body = love.physics.newBody(world, 550, 650-250/2 + level)
    objects.landscape2.shape = love.physics.newRectangleShape(200, 150 - level)
