function level1(level)
    ...
    objects.landscape = {}
    objects.landscape.body = love.physics.newBody(world, 350, 650-250/2 + level * 3)
    objects.landscape.shape = love.physics.newRectangleShape(150, 150 - level * 3)
    objects.landscape.fixture = love.physics.newFixture(objects.landscape.body, objects.landscape.shape)

    objects.landscape2 = {}
    objects.landscape2.body = love.physics.newBody(world, 550, 650-400/2 + level * 5)
    objects.landscape2.shape = love.physics.newRectangleShape(150, 300 - level * 5)
    ...
    blockobjects.block2 = {}
    blockobjects.block2.body = love.physics.newBody(world, 200, 550, "dynamic")
    ...
    blockobjects.block5 = {}
    blockobjects.block5.body = love.physics.newBody(world, 150, 400, "dynamic")
...
function level1_delete(world)
    world:destroy()
    --objects.ground.shape:destroy()
    --objects.ground.body:destroy()
    --world:DestroyBody(objects.ground.body)
    --objects.ground.fixture:destroy(objects.ground.body)

    --objects.landscape.fixture.destroy(objects.landscape.body)

    --objects.landscape2.fixture.destroy(objects.landscape2.body)
   
    --objects.ball.fixture.destroy(objects.ball.body)

    --objects.mustache.fixture.destroy(objects.mustache.body)
    
    --objects.block1.fixture.destroy(objects.block1.body)

    --objects.block2.fixture.destroy(objects.block2.body)

    --objects.block3.fixture.destroy(objects.block3.body)
end
